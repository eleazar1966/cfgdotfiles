...
" python3 plugins
call remote#host#RegisterPlugin('python3', '/home/eleazar/.local/share/nvim/lazy/molten-nvim/rplugin/python3/molten', [
      ...
      \ {'sync': v:true, 'name': 'MoltenToggleVirtual', 'type': 'command', 'opts': {'bang': '', 'nargs': '0'}},
